...
async function main(): Promise<void> {
  ...
  await prisma.entityCategory.createMany({
    data: [
      { entityId: usedIphone.id, categoryId: categories.find((category) => category.slug === "electronics")!.id },
      { entityId: usedIphone.id, categoryId: categories.find((category) => category.slug === "online-shopping")!.id },
      { entityId: bankCall.id, categoryId: categories.find((category) => category.slug === "online-shopping")!.id },
      { entityId: fiberSubscription.id, categoryId: categories.find((category) => category.slug === "telecom")!.id }
    ],
    skipDuplicates: true
  });
